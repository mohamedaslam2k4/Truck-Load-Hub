#  managaing deals and chnaging deal status 
...
# get loader deals and loader information
...
# start trip (ACCEPTED -> IN TRANSIT)
...
# driver complete deal (IN TRANSIT -> COMPLETED)
