            ...
            loads.map((load) => (
              <Card key={load.id || load._id}>
                <div className="load-header">
                  ...
                  <span className={`status ${(load.status || "AVAILABLE").toLowerCase()}`}>
                ...
                {load.status === "AVAILABLE" && (
                  <button type="button" className="cancel-button" onClick={() => handleCancelLoad(load.id || load._id)}>
                    Cancel Load
                  </button>
                )}
              </Card>
